use pdms_io::defines::{PageType, DataPageSubtype, verify_page_type, verify_data_page_subtype, PageTypeError};
...
fn test_data_page_subtype(subtype: DataPageSubtype, expected_value: u32, expected_name: &str, expected_bucket_id: u32) {
    // 测试 from_u32
