...
import { getLiveDir, validatePreviewId, getDiagramFilePath, deleteDiagram as deleteDiagramFiles, } from "./file-utils.js";
 ...
 */
export async function getDiagramInfo(previewId) {
    try {
 ...
 */
export async function diagramExists(previewId) {
    try {
        validatePreviewId(previewId);
