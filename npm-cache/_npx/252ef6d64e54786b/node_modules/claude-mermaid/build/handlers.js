...
import { getDiagramFilePath, getPreviewDir, saveDiagramSource, loadDiagramSource, loadDiagramOptions, validateSavePath, } from "./file-utils.js";
...
async function renderDiagram(options, liveFilePath) {
...
async function setupLivePreview(previewId, liveFilePath) {
...
function createLivePreviewResponse(liveFilePath, format, serverUrl, hasConnections) {
...
function createStaticRenderResponse(liveFilePath, format) {
    return {
        content: [
            {
                type: "text",
...
export async function handleMermaidPreview(args) {
    const diagram = args.diagram;
    const previewId = args.preview_id;
    const format = args.format || "svg";
    const theme = args.theme || "default";
    const background = args.background || "white";
    ...
    try {
        ...
        await renderDiagram({ diagram, previewId, format, theme, background, width, height, scale }, liveFilePath);
        if (format === "svg") {
...
export async function handleMermaidSave(args) {
