 ...
 */
export async function renderPage(contentTemplate, data, options = {}) {
    const { title = "Claude Mermaid", styles = [], scripts = [], includeNav = true, includeFooter = false, } = options;
    try {
